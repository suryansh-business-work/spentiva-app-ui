      ...
      {cards.map((card, index) => (
        ...
        >
          <CardContent sx={{ position: 'relative', zIndex: 1, p: { xs: 2, md: 2.5 } }}>
            <Typography variant="subtitle2" sx={{ opacity: 0.9, mb: 1, fontSize: { xs: '0.75rem', md: '0.85rem' }, fontWeight: 500 }}>
              {card.title}
            </Typography>
            <Typography variant="h3" sx={{ fontWeight: 700, mb: 0.5, fontSize: { xs: '1.75rem', sm: '2.25rem', md: '3rem' } }}>
              {card.value}
            </Typography>
