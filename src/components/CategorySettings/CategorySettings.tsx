    ...
    <Box>
      ...
      <Paper elevation={3} sx={{ p: 2 }}>
        {loading ? (
          ...
          <Alert severity="info">No categories found. Add your first category to get started.</Alert>
        ) : (
          <List>
                ...
                <Collapse in={expandedCategories.has(category.id)} timeout="auto" unmountOnExit>
                  <List component="div" disablePadding sx={{ ml: 4 }}>
                    {category.subcategories.map((subcategory) => (
                      ...
                      >
                        <SubdirectoryArrowRightIcon sx={{ mr: 1, fontSize: 20, color: "text.secondary" }} />
                        <ListItemText
                          primary={
      ...
      <Dialog open={openDialog} onClose={() => setOpenDialog(false)} maxWidth="sm" fullWidth>
        <DialogTitle>
          {dialogMode === "add" ? "Add" : "Edit"} {dialogType === "category" ? "Category" : "Subcategory"}
        </DialogTitle>
        <DialogContent>
          <TextField
            autoFocus
            ...
            onChange={(e) =>
              dialogType === "category" ? setCategoryName(e.target.value) : setSubcategoryName(e.target.value)
            }
            sx={{ mt: 2 }}
          />
